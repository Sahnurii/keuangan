...
class Buku_kas extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->view('buku_kas/index', $data);
        $this->view('templates/footer');
    }

    public function edit($id)
    {
        $data['kas'] = $this->model('Transaksi_model')->getTransaksiById($id);
        $data['judul'] = 'Edit Kas';
