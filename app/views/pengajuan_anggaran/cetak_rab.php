...
<body>
    ...
    <table class="table-info">
        <tr>
            <td width="160"><strong>Nama Pengusul</strong></td>
            <td width="10">:</td>
            <td><?= $pengajuan['nama_pegawai'] ?></td>
        </tr>
        <tr>
            <td><strong>Jabatan/Bidang</strong></td>
            <td>:</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td><?= tglBiasaIndonesia($pengajuan['tanggal_upload']) ?></td>
        </tr>
        <tr>
            <td><strong>Tanggal Disetujui</strong></td>
            <td>:</td>
            <td><?= tglBiasaIndonesia($pengajuan['tanggal_disetujui']) ?></td>
        </tr>
        <tr>
            <td><strong>Total Anggaran</strong></td>
            <td>:</td>
            <td><?= uang_indo($pengajuan['total_anggaran']) ?></td>
        </tr>
        <tr>
                ...
                <table style="margin-top: 10px;">
                    <tr>
                        <td style="text-align: center; font-weight: bold;">
                            <p><?= $pengajuan['jabatan_pimpinan'] ?? '-' ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <?php if (!empty($qr_path)) : ?>
                                <div style="margin-top: 20px;">
                                    <img src="<?= BASEURL . '/' . $qr_path ?>" alt="QR Code" width="150">
                                </div>
                            <?php endif; ?>
                        </td>
                    </tr>
