        ...
        <form action="<?= BASEURL; ?>/buku_bank/update" method="POST">
            ...
            <div class="container mt-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="input" class="form-control" id="nominal_transaksi" name="nominal_transaksi" value="<?= $data['Bank']['nominal_transaksi']; ?>" placeholder="Masukkan Nominal" required>
                    </div>
                </div>
