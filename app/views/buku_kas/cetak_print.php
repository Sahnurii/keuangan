...
<div class="header" style="font-size: 15pt;">Laporan Buku Pembantu Kas</div>
...
$html .= "<p>Pada hari ini, " . tglLengkapIndonesia(date('d F Y')) . ", Buku Pembantu Kas Ditutup dengan Saldo Akhir Sebesar " . uang_indo($saldo) . "</p><br>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Laporan_Buku_Pembantu_Kas.pdf', 'I');
