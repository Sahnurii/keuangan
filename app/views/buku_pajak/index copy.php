                        ...
                        <?php foreach ($data['transaksi'] as $transaksi) : ?>
                            <tr>
                                ...
                                <td class="text-center align-content-center">
                                    <a href="<?= BASEURL; ?>/buku_pajak/edit/<?= $transaksi['id']; ?>" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <a href="<?= BASEURL; ?>/transaksi/hapusPajak/<?= $transaksi['id']; ?>" class="btn btn-danger btn-sm tombol-hapus">
