        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASEURL; ?>/dashboard">
                <div class="sidebar-brand-icon ">
                    <img src="<?= BASEURL; ?>/img/Logo.png" alt="Logo" width="30" height="50">
                </div>
                <div class="sidebar-brand-text mx-3">POLITEKNIK BATULICIN</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= BASEURL; ?>/logout" data-toggle="modal" data-target="#logoutModal">
