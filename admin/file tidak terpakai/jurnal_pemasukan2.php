...
if (isset($_POST['get_saldo'])) {
    ...
    $saldo_terakhir = $data['saldo'];

    // Generate nomor bukti baru
    if ($data['no_bukti']) {
        // Ambil angka dari no_bukti terakhir
        $last_number = (int) substr($data['no_bukti'], 3);
...
if (isset($_POST['submit'])) {
    ...
    $no_bukti = $_POST['no_bukti'];  // Nomor bukti otomatis
            ...
            $('#lokasi_data').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#no_bukti').val(data.no_bukti); // Tampilkan nomor bukti
                    }
                });
            });
        });
