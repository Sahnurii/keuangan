    ...
    <div class="card card-primary">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <!-- Logo Kampus -->
                <div class="form-group row">
                    <label for="upload" class="col-sm-2 col-form-label">Logo Kampus</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="upload" name="gambar_kampus" />
                    </div>
                </div>
...
if ($query_ubah) {
  ...
  Swal.fire({title: 'Data Berhasil Disimpan',text: '',icon: 'success',confirmButtonText: 'OK'
    ...
    {window.location = 'home.php?page=data-kampus';
    }
  })</script>";
  }else{
  echo "<script>
