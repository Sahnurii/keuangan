...
$cekSaldo = "SELECT COUNT(*) AS total FROM b_pembantu_kas WHERE jenis_transaksi = 'saldo_awal'";
...
if (isset($_POST['submit']) && $row['total'] == 0) { // Tambah kondisi untuk cek saldo awal
    ...
    if ($tgl_transaksi && $keterangan && $penerimaan_debit) {
        $sql1 = "INSERT INTO b_pembantu_kas(tgl_transaksi, keterangan, penerimaan_debit, jenis_transaksi) VALUES ('$tgl_transaksi','$keterangan', '$penerimaan_debit', 'saldo_awal')";
    ...
    <div class="container mt-3">
        ...
        <div class="card card-info">
            ...
            <form action="" method="POST">
                <div class="card-body">
                    <div>
                        <a href="../data_pembantu_kas.php" class="btn btn-primary">KEMBALI</a>
                    </div>
                    <br>
